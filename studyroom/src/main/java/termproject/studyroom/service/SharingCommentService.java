...
public class SharingCommentService {
    ...
    private SharingCommentDTO mapToDTO(final SharingComment sharingComment,
        ...
        sharingCommentDTO.setAuthor(sharingComment.getAuthor() == null ? null : sharingComment.getAuthor().getStdId());
    ...
    private SharingComment mapToEntity(final SharingCommentDTO sharingCommentDTO,
        ...
        final User author = sharingCommentDTO.getAuthor() == null ? null : userRepository.findById(sharingCommentDTO.getAuthor())
